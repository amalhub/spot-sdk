...
IMAGE_SAVE_LOCATION = '/home/amalg/Desktop/spotcam'
...
class AsyncImageCapture(AsyncGRPCTask):
    ...
    def _handle_result(self, result):
        ...
        # save image to file
        image.save("/home/amalg/Desktop/spotcam/image.jpg")
...
class WasdInterface(object):
    ...
    def _take_ascii_image(self):
        source_names = ['frontright_fisheye_image', 'frontleft_fisheye_image', 'left_fisheye_image', 'right_fisheye_image', 'back_fisheye_image']
        ...
        for source_name in source_names:
            ...
            # save image to file
            imagename = IMAGE_SAVE_LOCATION + "/" + timestamp + "_" + source_name + '.jpg'
